!*********************************************************************************************************************************
! TMD_Driver: This code tests the template modules
!..................................................................................................................................
! LICENSING
...
PROGRAM TestTemplate
    ...
    INTEGER(IntKi), PARAMETER :: NumInp = 2 ! Number of inputs sent to TMD_UpdateStates
    ...
    TYPE(TMD_InitInputType) :: InitInData ! Input data for initialization
    TYPE(TMD_InitOutputType) :: InitOutData ! Output data from initialization
    
    TYPE(TMD_ContinuousStateType) :: x ! Continuous states
    ...
    TYPE(TMD_OutputType) :: y ! System outputs
    
    TYPE(TMD_ContinuousStateType) :: dxdt ! First time derivatives of the continuous states
...
!...............................................................................................................................
    ...
    IF ( ErrStat /= ErrID_None ) THEN ! Check if there was an error and do something about it if necessary
        ...
        CALL WrScr( ErrMsg )
    END IF
    CALL TMD_CopyInput( u(1), u(2), MESH_NEWCOPY, ErrStat, ErrMsg )
  
    ! read in nacelle data from file
    CALL U_ReadInput(APvec,AVvec,AAvec,LAvec, NumSteps, ErrStat, ErrMsg )
    
    ! Destroy initialization data
    CALL TMD_DestroyInitInput( InitInData, ErrStat, ErrMsg )
    CALL TMD_DestroyInitOutput( InitOutData, ErrStat, ErrMsg )
    !...............................................................................................................................
    ! Routines called in loose coupling -- the glue code may implement this in various ways
    !....................................................................................................
    ! setup the output file:
    OutputName = 'TMD_Output_Data.txt'
...
DO n = 0,NumSteps-1
       ...
       IF (n>0) THEN
         CALL TMD_CopyInput( u(2), u(1), MESH_UPDATECOPY, ErrStat, ErrMsg )
       ...
       CALL TMD_WriteOutputFile(x, y, UnOut,ErrStat,ErrMsg)
END DO
! close the output file
CALL TMD_CloseOutputFile(UnOut)
    !...............................................................................................................................
    ...
    !    ! DO
    !    !CALL TMD_CalcConstrStateResidual( Time, u(1), p, x, xd, z, OtherState, Z_residual, ErrStat, ErrMsg )
    !    !
    !    !IF ( ErrStat /= ErrID_None ) THEN ! Check if there was an error and do something about it if necessary
    !    !    CALL WrScr( ErrMsg )
    !    !END IF
    ...
    !    CALL TMD_CalcContStateDeriv( Time, u(1), p, x, xd, z, OtherState, dxdt, ErrStat, ErrMsg )
    !    
    !    IF ( ErrStat /= ErrID_None ) THEN ! Check if there was an error and do something about it if necessary
    !        CALL WrScr( ErrMsg )
    !    END IF
    ...
    !    !CALL TMD_UpdateDiscState( Time, n, u(1), p, x, xd, z, OtherState, ErrStat, ErrMsg )
    !    !
    !    !IF ( ErrStat /= ErrID_None ) THEN ! Check if there was an error and do something about it if necessary
    !    !    CALL WrScr( ErrMsg )
    !    !END IF
    ...
    !    ! Jacobians required:
    !    !CALL TMD_JacobianPInput( Time, u(1), p, x, xd, z, OtherState, dYdu=dYdu, dZdu=dZdu, ErrStat=ErrStat, ErrMsg=ErrMsg )
    !    !
    !    !IF ( ErrStat /= ErrID_None ) THEN ! Check if there was an error and do something about it if necessary
    !    !    CALL WrScr( ErrMsg )
    !    !END IF
    !    !
    !    !CALL TMD_JacobianPConstrState( Time, u(1), p, x, xd, z, OtherState, dYdz=dYdz, dZdz=dZdz, &
    ...
    CALL TMD_DestroyConstrState( Z_residual, ErrStat, ErrMsg )
    
    IF ( ErrStat /= ErrID_None ) THEN ! Check if there was an error and do something about it if necessary
        CALL WrScr( ErrMsg )
    END IF
    
    CALL TMD_DestroyContState( dxdt, ErrStat, ErrMsg )
    ...
    !...............................................................................................................................
    !CALL TMD_JacobianPInput( Time, u(1), p, x, xd, z, OtherState, dYdu, dXdu, dXddu, dZdu, ErrStat, ErrMsg )
    !
    !IF ( ErrStat /= ErrID_None ) THEN ! Check if there was an error and do something about it if necessary
    !END IF
    !
    !CALL TMD_JacobianPContState( Time, u(1), p, x, xd, z, OtherState, dYdx, dXdx, dXddx, dZdx, ErrStat, ErrMsg )
    !
    !IF ( ErrStat /= ErrID_None ) THEN ! Check if there was an error and do something about it if necessary
    !    CALL WrScr( ErrMsg )
    !END IF
    !
    !CALL TMD_JacobianPDiscState( Time, u(1), p, x, xd, z, OtherState, dYdxd, dXdxd, dXddxd, dZdxd, ErrStat, ErrMsg )
    !
    !IF ( ErrStat /= ErrID_None ) THEN ! Check if there was an error and do something about it if necessary
    !    CALL WrScr( ErrMsg )
    !END IF
    !
    !CALL TMD_JacobianPConstrState( Time, u(1), p, x, xd, z, OtherState, dYdz, dXdz, dXddz, dZdz, ErrStat, ErrMsg )
    !
    !IF ( ErrStat /= ErrID_None ) THEN ! Check if there was an error and do something about it if necessary
    !    CALL WrScr( ErrMsg )
    !END IF
    ...
    !...............................................................................................................................
    !CALL TMD_Pack(Re_SaveAry, Db_SaveAry, Int_SaveAry, u(1), p, x, xd, z, OtherState, y, ErrStat, ErrMsg)
    ...
    !...............................................................................................................................
    !CALL TMD_Unpack( Re_SaveAry, Db_SaveAry, Int_SaveAry, u(1), p, x, xd, z, OtherState, y, ErrStat, ErrMsg )
    ...
    ! CALL TMD_DestroyPartialOutputPInput ( ) ! Jacobian Routine not yet implemented
    !...............................................................................................................................
